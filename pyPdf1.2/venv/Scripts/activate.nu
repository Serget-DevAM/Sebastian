...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Serget\PycharmProjects\pyPdf1.2\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Serget\PycharmProjects\pyPdf1.2\venv\Scripts\deactivate.nu'
