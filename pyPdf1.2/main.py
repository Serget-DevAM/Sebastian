    ...
    for f in files:
        ...
        if checkString.upper() in f.upper():
            ...
            if ext.upper() in f.upper():
                ...
                print("valor: " split + splitdata1[25])
                splitdata1[ancorar(splitdata1, "156") + 10]

                print("ancorar(splitdata1, 156): ")
                ...
                nomeclatura = "ENEL RADAR - " + nf + " - R$ " + splitdata1[ancorar(splitdata1, "156")+10] + " - 210043 - " + chavedia + "." + mesNum[key] + "." + "" + "2023"
